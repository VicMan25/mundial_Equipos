...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .callout {
                background-image: url('recursos/assets/img/ImgSVG/mapaSedes.jpg');
    ...
    <body id="page-top">
        ...
        <nav id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand"><a href="#page-top">Equipos</a></li>
...
<div class="container text-center"> 
    <select class="form-select mb-3 border border-primary mx-auto" aria-label="Seleccionar equipo" style="width: auto;">
...
<div class="container">
    <div class="row gx-4 gx-lg-5">
        ...
        <div class="col-lg-6 text-center"> <!-- Agregado 'text-center' para centrar -->
            <h3>Jugadores</h3>
            <ul id="player-list">
                <!-- Aquí se generarán dinámicamente los nombres de los jugadores -->
            </ul>
        </div>
        ...
        <div class="col-lg-6 text-center"> <!-- Agregado 'text-center' para centrar -->
            ...
            <div id="player-info">
                <!-- Aquí se mostrará la información detallada de cada jugador -->
            </div>
        </div>
    </div>
</div>
